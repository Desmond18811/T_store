...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineSmall: const TextStyle().copyWitg(fontSize:16, FontWeight: FontWeight.w600, color:Colors.black),
    ...
    labelLarge: const TextStyle().copyWith(fontSize: 14, FontWeight: FontWeight.w500, color: Colors.black),
    labelMedium: const TextStyle().copyWith(fontSize: 14, FontWeight: FontWeight.normal, color: Colors.black),
    labelSmall: const TextStyle().copyWith(fontSize: 14, FontWeight: FontWeight.w500, color: Colors.black)
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    headlineSmall: const TextStyle().copyWitg(fontSize:16, FontWeight: FontWeight.w400, color:Colors.white),
